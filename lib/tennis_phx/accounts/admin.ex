defmodule TennisPhx.Accounts.Admin do
  use Ecto.Schema
  ...
  defp validate_email(changeset) do
    ...
    |> unsafe_validate_unique(:email, TennisPhx.Repo)
  ...
  """
  def valid_password?(%TennisPhx.Accounts.Admin{hashed_password: hashed_password}, password)
