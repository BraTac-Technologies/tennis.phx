defmodule TennisPhxWeb.LocationControllerTest do
  use TennisPhxWeb.ConnCase

  import TennisPhx.LocationsFixtures

  @create_attrs %{city: "some city", country: "some country", description: "some description", image: "some image", name: "some name"}
