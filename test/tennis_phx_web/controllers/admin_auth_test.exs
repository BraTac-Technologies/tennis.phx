defmodule TennisPhxWeb.AdminAuthTest do
  use TennisPhxWeb.ConnCase, async: true

  alias TennisPhx.Accounts
  alias TennisPhxWeb.AdminAuth
  import TennisPhx.AccountsFixtures

  @remember_me_cookie "_tennis_phx_web_admin_remember_me"

  setup %{conn: conn} do
    conn =
      conn
      |> Map.replace!(:secret_key_base, TennisPhxWeb.Endpoint.config(:secret_key_base))
      |> init_test_session(%{})
  ...
  describe "logout_admin/1" do
    ...
    test "broadcasts to the given live_socket_id", %{conn: conn} do
      ...
      TennisPhxWeb.Endpoint.subscribe(live_socket_id)
